  ...
  useEffect(() => {
    ...
    */
    ...
    ScrollTrigger.create({
      ...
      markers: false,
      onEnter: ({ progress, direction, isActive }) => {
        gsap.to(childWrapperRef.current, {
          filter: `blur(0px)`,
          duration: 1.5,
        });
    ...
    // New York
    world.findLocation(40.7128, -74.006, world.earth, 0.14);
  }, []);
  ...
  useEffect(() => {
    ...
    ScrollTrigger.create({
      ...
      onUpdate: (self) => {
        ...
        const maxScroll =
          childWrapperRef.current.scrollHeight -
          childWrapperRef.current.offsetHeight;
        ...
        childWrapperRef.current.scrollTop = scrollPos;
      },
          ...
          <div className={styles.contactWrap}>
            <div className={styles.contactDetails}>
              <div className={styles.contactScroll}>
                A right hand to strategy, our team is both innovative and
                insightful, offering end to end solutions that streamline and
                maximize clients vision, resources, and impact.
              </div>
            </div>
          </div>
          <h3>Offerings</h3>
