...
export default function Index() {
    ...
    return (
        ...
        Select Select Commissions Include <span style={{marginLeft: "20vw"}}>Select Select Commissions Include
    </span><span style={{marginLeft: "20vw"}}>Select Select Commissions Include
    </span><span style={{marginLeft: "20vw"}}>Select Select Commissions Include
    </span>
        </div>
